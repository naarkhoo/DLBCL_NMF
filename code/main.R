...
DISSECTOR_make_heatmap_of_matrix.v1(
	...
	output_plot_landscape    = "/home/superiois/Downloads/projectx3/DLBCL_NMF/plots/clique_DLBCL_n978x323.H_w_LPLOT.pdf",  # Output (PDF) file
	output_plot_portrait     = "/home/superiois/Downloads/projectx3/DLBCL_NMF/plots/clique_DLBCL_n978x323.H_w_PPLOT.pdf")  # Output (PDF) file
